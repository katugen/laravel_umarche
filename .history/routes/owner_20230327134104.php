...
Route::prefix('shops')->middleware('auth:owners')->group(function () {
    Route::get('index', [ShopsController::class, 'expiredOwnerIndex'])->name('expired-owners.index');
    Route::get('edit/{shop}', [ShopsController::class, 'expiredOwnerDestroy'])
        ->name('expired-owners.destroy');
    Route::get('update/{shop}', [ShopsController::class, 'expiredOwnerDestroy'])
        ->name('expired-owners.destroy');
});
