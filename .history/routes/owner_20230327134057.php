...
Route::prefix('shops')->middleware('auth:owners')->group(function () {
    Route::get('index', [Controller::class, 'expiredOwnerIndex'])->name('expired-owners.index');
    Route::get('edit/{shop}', [Controller::class, 'expiredOwnerDestroy'])
        ->name('expired-owners.destroy');
    Route::get('update/{shop}', [Controller::class, 'expiredOwnerDestroy'])
        ->name('expired-owners.destroy');
});
