...
Route::prefix('shops')->middleware('auth:owners')->group(function () {
    Route::get('index', [ShopController::class, 'expiredOwnerIndex'])->name('expired-owners.index');
    Route::get('edit/{shop}', [ShopController::class, 'expiredOwnerDestroy'])
        ->name('expired-owners.destroy');
    Route::get('update/{shop}', [ShopController::class, 'expiredOwnerDestroy'])
        ->name('expired-owners.destroy');
});
